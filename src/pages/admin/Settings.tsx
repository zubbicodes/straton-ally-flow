import { Settings as SettingsIcon, Building2, User, Bell, Shield, Database, Clock, MapPin, Wifi, Globe, UserPlus } from 'lucide-react';
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="card-elevated">
            <CardHeader>
              ...
              <CardDescription>Manage offices, schedules, and access control</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Notifications for access denied events
                  </p>
                </div>
                <Switch disabled />
              </div>
